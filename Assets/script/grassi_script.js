...
function OnCollisionEnter (collision : Collision){
	PlayerPrefs.SetString("collision", "gras");
	logica_barre.SetFoodUp(15, 3);
	audio_coll.play=true;
	if(GameObject.Find("grassi_instruction")){
		gameObject.Find("grassi_instruction").guiTexture.enabled = true;
		Time.timeScale = 0;
	}
