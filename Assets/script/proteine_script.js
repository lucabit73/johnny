...
function OnCollisionEnter (collision : Collision){
	PlayerPrefs.SetString("collision", "prot");
	logica_barre.SetFoodUp(5, 2);
	audio_coll.play=true;
	if(GameObject.Find("proteine_instruction")){
		gameObject.Find("proteine_instruction").guiTexture.enabled = true;
		Time.timeScale = 0;
	}
